...
## Expected Result
- PR created/updated with proper template
- Screenshots embedded with `width="400"`
- PR linked to Issue (appears in Development sidebar)
- Issue body updated with PR references
